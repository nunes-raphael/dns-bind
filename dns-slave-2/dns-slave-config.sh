...
sudo cp /vagrant/dns-slave-2/named.conf /etc/named.conf
sudo cp /vagrant/dns-slave-2/named.conf.local /etc/named/named.conf.local
sudo cp /vagrant/dns-slave-2/check_bind.sh /root/check_bind.sh
