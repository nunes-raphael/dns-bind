...
sudo cp /vagrant/dns-slave-3/named.conf /etc/named.conf
sudo cp /vagrant/dns-slave-3/named.conf.local /etc/named/named.conf.local
sudo cp /vagrant/dns-slave-3/check_bind.sh /root/check_bind.sh
